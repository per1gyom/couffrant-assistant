...
class _ChatScreenState extends State<ChatScreen> {
        ...
        return StatefulBuilder(builder: (ctx, setSheetState) {
          return Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              const Text('Vitesse de la voix', style: TextStyle(
              ...
              Row(children: [
                ...
                Expanded(child: SliderTheme(
                  ...
                  child: Slider(
                    value: localSpeed, min: 0.5, max: 2.5, divisions: 20,
                    label: '${localSpeed.toStringAsFixed(1)}x',
                    onChanged: (v) {
                      setSheetState(() => localSpeed = v);
                      setState(() => _tts.speed = v);
                    },
                  ),
                )),
              ...
              Text('${localSpeed.toStringAsFixed(1)}x',
                style: const TextStyle(color: Color(0xFF22C55E), fontSize: 24, fontWeight: FontWeight.w600)),
              const SizedBox(height: 8),
              TextButton(onPressed: () {
                setSheetState(() => localSpeed = 1.2);
                setState(() => _tts.speed = 1.2);
              }, child: Text('R\u00e9initialiser (1.2x)',
  ...
  @override
  void dispose() {
    _inputController.dispose(); _scrollController.dispose();
    _inputFocus.dispose(); _tts.dispose(); super.dispose();
  }
          ...
          children: [
            ...
            if (!isUser && msg.ariaMemoryId != null)
              Padding(padding: const EdgeInsets.only(top: 4), child: Row(mainAxisSize: MainAxisSize.min, children: [
                _feedbackBtn('\ud83d\udd0a', () { if (_tts.isSpeaking) _tts.stop(); else _tts.speak(msg.text); }),
                _feedbackBtn('\ud83d\udc4d', () {}), _feedbackBtn('\ud83d\udc4e', () {}),
                _feedbackBtn('\ud83d\udca1', () {}), _feedbackBtn('\ud83d\udc1b', () {}),
              ])),
          ],
        )),
