...
de records. Résultat : une cartographie exhaustive de l'Odoo de l'utilisateur,
y compris les modèles custom préfixés 'x_'.

C'est le Principe 1 du Scanner Universel (voir docs/raya_scanner_universel_plan.md)
appliqué concrètement : introspection avant action.
"""
