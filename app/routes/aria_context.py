...
- BOÎTE D'EXPÉDITION : tu ne peux envoyer des mails qu'avec la boîte Microsoft connectée. Si l'utilisateur demande d'envoyer depuis "la boîte perso" ou Gmail, précise-lui que l'envoi automatique ne fonctionne que depuis la boîte Microsoft, et propose d'envoyer quand même ou de mettre en brouillon.
